...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('NEW', 'SERIOUS', 'CONVERTED', 'LOST', name='clientstatus'), nullable=False),
    sa.Column('intent', sa.Enum('BUY', 'INVEST', 'RENT', name='clientintent'), nullable=True),
    ...
    sa.Column('doc_type', sa.Enum('PROPERTY_LISTING', 'AREA_GUIDE', 'POLICY', 'FAQ', 'DEVELOPER_PROFILE', 'LEGAL', name='companydoctype'), nullable=False),
    ...
    sa.Column('retry_status', sa.Enum('PENDING', 'RETRIED', 'ABANDONED', name='retrystatus'), nullable=True),
    ...
    sa.Column('property_type', sa.Enum('APARTMENT', 'HOUSE', 'PLOT', 'VILLA', 'COMMERCIAL', name='propertytype'), nullable=False),
    ...
    sa.Column('filename', sa.VARCHAR(), nullable=False),
    sa.Column('doc_type', sa.Enum('SALE_DEED', 'NOC', 'BANK_STATEMENT', 'CNIC', 'FLOOR_PLAN', 'BROCHURE', 'OTHER', name='clientdoctype'), nullable=False),
    sa.Column('page_count', sa.INTEGER(), nullable=True),
    sa.Column('token_count', sa.INTEGER(), nullable=True),
    sa.Column('storage_status', sa.Enum('INJECTED', 'CHUNKED', name='storagestatus'), nullable=True),
    sa.Column('created_at', postgresql.TIMESTAMP(), nullable=True),
    ...
    sa.Column('client_phone', sa.VARCHAR(), nullable=False),
    sa.Column('meeting_type', sa.Enum('VIRTUAL_CONSULTATION', 'PROPERTY_TOUR', 'DOCUMENT_SIGNING', 'FOLLOWUP', name='meetingtype'), nullable=False),
    ...
    sa.Column('status', sa.Enum('SCHEDULED', 'COMPLETED', 'CANCELLED', 'NO_SHOW', name='meetingstatus'), nullable=False),
